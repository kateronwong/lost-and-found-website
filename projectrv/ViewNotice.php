...
<header>
	...
	<div class="container">
			<div class="btn-table">
				...
				<div class="vabtn"><a href = "ViewNotice.php" ><button id="vb" disabled>View Notices</button></a></div>
			</div>
			
			<div class="navigate">All Notices (Most Recently)</div>
            ...
            <div class="posts-table">
				...
				<?php
					...
					$userQuery = "SELECT * FROM notice ORDER BY date ASC";
					$result = mysqli_query($connect, $userQuery);
