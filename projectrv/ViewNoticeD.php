	...
	include "mysql-connect.php";
					...
					if ($_GET["id"]){
							...
							if (mysqli_num_rows($result) == 0) {
								...
								$userQuery = "SELECT * FROM userdata where ID = '$rp' ";
								$result = mysqli_query($connect, $userQuery);
								if (mysqli_num_rows($result) == 0) {
								}else { 
									while ( $row = mysqli_fetch_assoc($result)){
...
<header>
	...
	<div class="container">
			...
			<div class="navigate">Notices Details</div>
			...
			<div class="topic-container">
				<div class="head">
					...
					<?php
									...
									echo "</div>";
										...
										echo "<div class='content'>";
											...
											if ($completed == "F")
											{
													...
													echo "<a href ='Respond.php?id=$nid'><button class='rbtn'>"."Respond"."</button></a>";
													echo "</div>";
												echo "</div>";
											}else
											{
									...
									<div class="topic-container">
									<div class="head">
										<div class="rauthorsD">Responder</div>
										<?php
										if ($completed =="T")
										{
											echo "<div class='rdateD'>" . "Responded on: " .$rdate ."</div>";
											echo "</div>";
											echo "</div>";

											echo "<div class='body'>";
												echo "<div class='authorsD'>";
													echo "<div class='username'>" . $rp . "</div>";
													
												echo "<img src='images/". $rpicon ."' >";
										...
										}else 
										{
											...
											echo "</div>";
											echo "<div class='body'>";
												echo "<p class='nr'>"."Still not respond!!" ."</p>";
											echo "</div>";
										}
										?>
									</div>
