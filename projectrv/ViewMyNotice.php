...
<header>
	...
	<div class="container">
			...
			<div class="navigate">User Information</div>
            <div class="posts-table">
				<div class="table-head">
					<div class="name">User Image</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo "<img class='uimg' src='images/". $usericon ."' >"; ?></div>
				</div>
                <div class="table-head">
					<div class="name">User ID</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo $id; ?></div>
				</div>
				<div class="table-head">
					<div class="name">Nick Name</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo $nickname; ?></div>
				</div>
				<div class="table-head">
					<div class="name">Email</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo $email; ?></div>
				</div>
				<div class="table-head">
					<div class="name">Gender</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo $gender; ?></div>
				</div>
				<div class="table-head">
					<div class="name">Birthday</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo $birthday; ?></div>
				</div>
				<div class="table-head">
					<div class="name">Age</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo $age; ?></div>
				</div>
				<div class="table-head">
					<div class="name">Password</div>
    			</div>
				<div class='table-row'>	
					<div class='inf'><?php echo $password; ?></div>
				</div>
			</div>
			<div class="btn-table">
				<div class="ebtn"><a href = "edit.php"><button id="eb">Edit</button></a></div>
			</div>
		</div>
	

	<div class="container">
			<div class="navigate">Notices Created</div>
            <div class="posts-table">
                <div class="table-head">
				...
				<?php
					...
					if ($_GET["id"]){
						$cid =$_GET["id"];
						$userQuery = "SELECT * FROM notice where creatorID = '$cid' ORDER BY date ASC" ;
						$result = mysqli_query($connect, $userQuery);
			...
			<div class="container">	
			<div class="navigate">Notices Responded</div>
            <div class="posts-table">
                <div class="table-head">
					<div class="type">Type</div>
                    <div class="topic">Topic</div>
				...
				<?php
					...
					if ($_GET["id"]){
						$cid =$_GET["id"];
						$userQuery = "SELECT * FROM notice where respondperson = '$cid' ORDER BY date ASC" ;
						$result = mysqli_query($connect, $userQuery);
